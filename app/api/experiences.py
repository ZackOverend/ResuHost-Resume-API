...
def get_experience(user_id: int, exp_id: int, db: Session = Depends(get_db)):
...
def update_experience(user_id: int, exp_id: int, exp: schemas.ExperienceCreate, db: Session = Depends(get_db)):
